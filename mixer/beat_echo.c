...
void beat_echo_process(EchoAudio *s,EchoQuantize *q,EchoPlayerFixture *player,Stereo *ring,const Stereo *in,Stereo *out,unsigned n){
 ...
 if(echo_quantize_check(q,player))echo_quantize_time(s,q,player);
}
