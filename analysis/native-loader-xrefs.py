...
targets={0xa6de18:'ITrackLoader slot2 thunk',0xa6d300:'ITrackLoader slot3 thunk',0xa6d308:'TrackLoader slot2 body',0xa6c808:'TrackLoader slot3 body'};out=[]
for s in ss:
...
(b/'analysis/az-native-loader-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
