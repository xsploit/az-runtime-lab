...
targets={0x29f6c28:'CrossfaderAssignDeckWidgetController primary'};out=[]
for s in ss:
...
(b/'analysis/az-crossfader-controller-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
