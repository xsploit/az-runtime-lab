...
ids=[0x003abc876b2f2aea,0x0015418214bc7d89,0x01ce23eafdd238ca,0x01a8a8e5a75f8b69]
hits=[]
for s in sections:
  ...
  for j in range(1,17):
   ...
   if x&0xff800000==0xf2800000 and x&31==reg:
    ...
    if value in ids:
     ...
     break
out=base/'analysis/az-load-button-id-xrefs.json';out.write_text(json.dumps(hits,indent=2)+'\n')
