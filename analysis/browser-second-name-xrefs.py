...
targets={0x3baf678:'second Browse group name'};out=[]
for s in ss:
...
(b/'analysis/az-browser-second-name-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
