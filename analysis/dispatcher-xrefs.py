...
targets={0x2e48338:'RxDataDispatcher primary vtable'};out=[]
for s in ss:
...
(b/'analysis/az-mixer-dispatcher-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
