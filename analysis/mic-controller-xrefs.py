...
targets={0x29f22c0:'BeatFxMicWidgetController primary vtable'};out=[]
for s in ss:
...
(b/'analysis/az-mic-controller-constructor-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
