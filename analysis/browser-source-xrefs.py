...
targets={0x3baf668:'browser GUI source global'};out=[]
for s in ss:
...
(b/'analysis/az-browser-source-global-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
