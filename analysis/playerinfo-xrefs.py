...
targets={0x2e422e8:'PlayerInfoReciever primary vtable'};out=[]
for s in ss:
...
(b/'analysis/az-playerinfo-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
