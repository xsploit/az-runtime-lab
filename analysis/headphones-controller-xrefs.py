...
targets={0x2a01f60:'HeadphonesWidgetController primary',0x2a01fa8:'HeadphonesWidgetController listener'};out=[]
for s in ss:
...
(b/'analysis/az-headphones-controller-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
