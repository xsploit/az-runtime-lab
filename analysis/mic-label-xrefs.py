...
targets={0x2c93598:'MIC1',0x2c935a0:'MIC2',0x2c935a8:'MIC1+2'};out=[]
for s in ss:
...
(b/'analysis/az-mic-label-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
