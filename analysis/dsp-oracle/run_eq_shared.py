...
files=['eq_shared_compare.c','../../mixer/cfx_filter.c','../../mixer/cfx_manager.c','../../mixer/cfx_noise.c','../../mixer/cfx_crush.c','../../mixer/cfx_sweep.c','../../mixer/cfx_dubecho.c','../../mixer/cfx_space.c'];gcc=root/'rx3-human-delegation/scratch/debbin/arm-linux-gnueabi-gcc'
commands=[[str(gcc),*flags,'-static','-mfpu=neon','-mfloat-abi=softfp',*files,'equalizer-native.S','isolator-native.S','eq-ctor-native.S','eq-cfx-channel-native.S','manager-native.S','native.S','-lm','-o','eq-shared-arm'],['cc',*flags,'-DHOST_REPLAY',*files,'-lm','-o','eq-shared-host'],['cc',*flags,'-DHOST_REPLAY','-fsanitize=address,undefined','-fno-omit-frame-pointer',*files,'-lm','-o','eq-shared-host-asan']]
for cmd in commands:subprocess.run(cmd,cwd=here,check=True)
results={}
for label,cmd in [('arm',['qemu-arm-static','./eq-shared-arm']),('host',['./eq-shared-host']),('sanitized',['./eq-shared-host-asan'])]:
