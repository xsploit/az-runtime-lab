...
Five direct targets now have more specific cross-file semantics (partial roles are explicitly marked):
...
The regenerated ledger preserves all53 direct calls, their order and all bounded instruction-window observations. The two new role annotations come from targeted research beyond those windows; they do not upgrade the windows into complete function maps.
