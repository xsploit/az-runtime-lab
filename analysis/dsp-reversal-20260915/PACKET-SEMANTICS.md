...
This matters in the shared Beat11/12 body: LDHU at0x80010500 loads state halfword514 into B3, and CMPGT at0x80010504 immediately compares B3 before the load result is available. But BNOP at0x80010508 has count3. Later SET0x8001050e and CMPLT0x80010510 must be timed with those inserted cycles; counting decoded packets as consecutive cycles can incorrectly classify the later comparison as reading the old B3 too. The prior-value source and entry branches still require a complete path trace before assigning the whole piecewise control formula.
