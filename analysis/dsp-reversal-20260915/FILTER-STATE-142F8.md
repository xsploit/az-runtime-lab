...
PROT impact recheck: a full-listing header scan finds no protected loads in0x11814300–0x11814564, covering the reviewed filter prologue/core/writeback. The missing PROT handling therefore does not alter this region's local packet timing. This narrow result does not validate caller timing or remove the model's separate floating-point/alias limitations. See PACKET-SEMANTICS.md.
