...
targets={0x21301e8:'Mixer playerInfoReciever accessor'};out=[]
for s in ss:
...
(b/'analysis/az-playerinfo-accessor-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
