"""Pinned AZ RTTI references and vtable candidates for native search/menu work."""
...
for t in json.loads((b/'analysis/xdjaz-rtti.json').read_text())['types']:
 if t['type'] not in ['gui::BrowseMenuWidgetController','gui::status_area::browse::SearchBarWidgetController','gui::status_area::browse::NormalSearchBarWidgetController','gui::browse::SearchView','gui::status_area::browse::SearchTracksBarWidgetController','gui::browser_logic::KeywordSearchFacade']:continue
...
(b/'analysis/az-search-menu-vtables.json').write_text(json.dumps(result,indent=2)+'\n')
