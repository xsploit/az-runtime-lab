...
targets={0x2e4a490:'TxDataBuilder primary vtable'};out=[]
for s in ss:
...
(b/'analysis/az-tx-builder-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
