...
targets={39673488: 'loadDeck1 diagnostic', 39673560: 'loadDeck2 diagnostic', 39673632: 'loadDeck3 diagnostic', 39673704: 'loadDeck4 diagnostic'};out=[]
for s in ss:
...
(b/'analysis/az-load-deck-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
