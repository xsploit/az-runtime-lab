...
base=lab_path();model=os.environ.get('PLAYER','xdjaz');lab=base/model;lab.mkdir(exist_ok=True);root=lab_path(model+'/rootfs');state=lab_path(model+'/state');state.mkdir(parents=True,exist_ok=True)
clock_temp=None
