...
targets={0x25d40a8:'primaryDeckSelect',0x25d40f8:'secondaryDeckSelect'};out=[]
for s in ss:
...
(b/'analysis/az-deck-select-diagnostic-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
