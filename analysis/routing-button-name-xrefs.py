...
targets={0x29f6b80:'aButton',0x29f6b88:'bButton',0x29f6b90:'thruButton',0x2a01ec0:'monoSplitButton',0x2a01ed0:'stereoButton',0x2a091b8:'minus9DbButton',0x2a091c8:'minus6DbButton',0x2a091d8:'minus3DbButton',0x2a091e8:'0DbButton'};out=[]
for s in ss:
...
(b/'analysis/az-routing-button-name-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
