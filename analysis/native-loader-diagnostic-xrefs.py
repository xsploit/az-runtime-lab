...
targets={40684368: 'execute explicit deck diagnostic', 40684088: 'execute implicit deck diagnostic', 40684664: 'doLoadTrack diagnostic', 41490048: 'UsecaseTrackLoader registry name'};out=[]
for s in ss:
...
(b/'analysis/az-native-loader-diagnostic-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
