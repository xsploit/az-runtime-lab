...
targets={}
for needle in [b'gui::waveform::DetailedWaveformWidget::update - gridMaker.makeGridImage begin', b'Waveform/BeatMeasure', b'N3gui17detailed_waveform11BeatMeasureE']:
 offset=d.find(needle)
 if offset<0:continue
 for section in ss:
  if section[4]<=offset<section[4]+section[5]:
   targets[section[3]+offset-section[4]]=needle.decode();break
out=[]
for s in ss:
...
(b/'analysis/az-grid-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
