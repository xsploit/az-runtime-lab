"""Pinned AZ detailed waveform RTTI and vtable candidates."""
...
for t in json.loads((b/'analysis/xdjaz-rtti.json').read_text())['types']:
 if 'gui::waveform::DetailedWaveformWidget<' not in t['type']:continue
...
(b/'analysis/az-detailed-waveform-vtables.json').write_text(json.dumps(result,indent=2)+'\n')
