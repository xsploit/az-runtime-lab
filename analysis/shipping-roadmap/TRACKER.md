...
The [coefficient store/load layout](../dsp-reversal-20260915/STORE-LAYOUT.md) now matches the documented little-endian register-pair ordering to both coefficient writers and the sample routine loads. The three-word plus two-word interface is established statically; full pointer provenance and sample recurrence remain open.
