...
for t in json.loads((b/'analysis/xdjaz-rtti.json').read_text())['types']:
 if t['type'] not in ['device_adapter::mixer::Mixer','usecase::mixer::Mixer','usecase::mixer::MasterEq','gui::mixer_settings::EqIsoWidgetController','gui::mixer_settings::EqIsoWidget','device_adapter::mixer::MasterEQ','application_setting::EqIsoSetting']:continue
...
(b/'analysis/az-eq-mode-vtables.json').write_text(json.dumps(result,indent=2)+'\n')
