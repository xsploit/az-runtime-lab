...
targets={0x2d8fa58:'PadStemWidget primary vtable',0x2d8fa10:'PadStemWidget typeinfo'};out=[]
for s in ss:
...
(b/'analysis/az-stem-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
