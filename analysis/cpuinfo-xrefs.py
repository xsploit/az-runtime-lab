...
targets={0x313afa8:'/proc/cpuinfo',0x313b038:'cpu cores'};out=[]
for s in ss:
...
(b/'analysis/az-cpuinfo-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
