...
targets={48502568: '/sys/module/rockchipdrm/parameters/vsync_time', 48502240: 'double device_adapter::VsyncTime::retrieveLastVsyncMsec() const', 41761256: '0 < lines.size()', 48502664: '0<remain_msec'};out=[]
for s in ss:
...
(b/'analysis/az-vsync-xrefs.json').write_text(json.dumps(out,indent=2));print(json.dumps(out,indent=2))
